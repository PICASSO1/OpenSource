...
// Even : get (world access), even : set (root access)
...
// Note : if you more than 8 TXPowers, just set the max and min or a few of them in the struct iw_range.
...
struct iw_scan_req {
	...
	__u8            essid_len;
	__u8            num_channels;   // num entries in channel_list; 0 = scan all allowed channels
